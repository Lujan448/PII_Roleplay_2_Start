...
namespace Dwarfs
{
    public class Dwarf
    {
        ...
        public void ChangeItem(Axe newAxe)
        {
            this.AttackValue = newAxe.AttackValue;  
        }

        public void ChangeItem(Shield newShield)
        {
        ...
        public void RemoveItem(Axe axe)
        {
            this.AttackValue = 0;
            this.DefenseValue = 0;
        }

        public void RemoveItem(Shield shield)
        {
            this.AttackValue = 0;
            this.DefenseValue = 0;
        }
        ...
        public void ThrowCure(Potion potion, Elf target, PotionInventory inventory)
        {
